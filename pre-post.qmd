...
results_long <- results_data %>%
  ...
  mutate(Time = factor(Time, levels = c("Pre Mean", "Post Mean")))
...
ggplot(results_long, aes(x = Time, y = MeanScore, fill = Time)) +
  ...
  theme_minimal()+
  scale_fill_manual(values = c("Pre Mean" = "pink", "Post Mean" = "lightblue")) +
  theme(
